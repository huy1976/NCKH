...
Dưới đây là bảng so sánh các chỉ số đánh giá (Precision, Recall, F1-Score) giữa mô hình chuẩn 1D-CNN và mô hình Hybrid trên từng loại lỗi ổ bi (Bearing Fault):

| Class (Lớp lỗi) | Precision (1D-CNN) | Recall (1D-CNN) | F1-Score (1D-CNN) | Precision (Hybrid) | Recall (Hybrid) | F1-Score (Hybrid) |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Ball** | 0.6646 | 0.7472 | 0.7035 | 0.7218 | 0.7788 | 0.7492 |
| **Inner** | 0.9966 | 0.9996 | 0.9981 | 1.0000 | 0.9991 | 0.9996 |
| **Normal** | 0.6681 | 0.6513 | 0.6596 | 0.7234 | 0.7401 | 0.7316 |
| **Outer** | 0.8146 | 0.7314 | 0.7708 | 0.9012 | 0.8100 | 0.8532 |

### 🎯 Tổng quan hiệu suất chung:
* **Accuracy:** 
  * 1D-CNN: **0.7824**
  * Hybrid: **0.8320** *(Tăng đáng kể)*
* **Macro F1-Score:** 
  * 1D-CNN: **0.7830**
  * Hybrid: **0.8334**
